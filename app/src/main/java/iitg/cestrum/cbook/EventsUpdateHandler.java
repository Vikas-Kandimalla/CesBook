 ...
 */
 ...
 class EventsUpdateHandler {
    ...
    EventsUpdateHandler(Context context,RecyclerView recyclerView){
        this.context = context;
        this.recyclerView = recyclerView;
        dBaseHandler = new DBaseHandler(this.context);
    ...
    EventsUpdateHandler(Context context){
        this.context = context;
        dBaseHandler = new DBaseHandler(this.context);
        dBaseHandler.resetTempCache();
        nowDate = Calendar.getInstance();
    ...
    ArrayList<Event> getEvents() {
        return EventsUpdateHandler.events;
    }
